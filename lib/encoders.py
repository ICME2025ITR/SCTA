...
class VisionTransEncoder(nn.Module):
    def __init__(self, opt):
        ...
        if 'swin' in opt.vit_type:                           
            ...
            self.visual_encoder = SwinModel.from_pretrained("/Workplace_sdb/lhl/microsoft/swin-base-patch4-window7-224")
        ...
        #  ViT model
            ...
            self.visual_encoder = ViTModel.from_pretrained("/Workplace_sdb/lhl/google/vit-base-patch16-224-in21k")
...
class EncoderText_BERT(nn.Module):
    def __init__(self, opt):
        ...
        self.tokenizer = BertTokenizer.from_pretrained('/Workplace_sdb/lhl/bert-base-uncased')
        self.bert = BertModel.from_pretrained('/Workplace_sdb/lhl/bert-base-uncased')
