    ...
    for i, data_i in enumerate(data_loader):
        ...
        if i % log_step == 0:
            logging('Test: [{0}/{1}]\t'
                    ...
                    .format(i, len(data_loader.dataset) // data_loader.batch_size + 1, batch_time=batch_time,
...
def evalrank(model_path, model=None, data_path=None, split='dev', fold5=False, save_path=None):
    ...
    tokenizer = BertTokenizer.from_pretrained('/Workplace_sdb/lhl/bert-base-uncased')
