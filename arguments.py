...
def get_argument_parser():
    ...
    parser.add_argument('--f30k_img_path', type=str, default='/Workplace_sdb/lhl/data/flickr30k_images',
                        help='the path of f30k images')
    parser.add_argument('--coco_img_path', type=str, default='/Workplace_sdb/lhl/data/coco_images', help='the path of coco images')
    ...
    parser.add_argument('--bert_path', type=str, default='/Workplace_sdb/lhl/bert-base-uncased')
    ...
    parser.add_argument('--img_sparse_ratio', type=float, default=0.5, help='the sprase rate for visual token')
    parser.add_argument('--img_aggr_ratio', type=float, default=0.3, help='the aggr rate for visual token')
    parser.add_argument('--attention_weight', type=int, default=0.8,
                        help='the weight of attention_map for mask prediction')
    parser.add_argument('--cap_aggr_ratio', type=float, default=0.75, help='the aggr rate for visual token')
    parser.add_argument('--monitor_weight', type=float, default=2.0, help='if use detach for kt loss')
